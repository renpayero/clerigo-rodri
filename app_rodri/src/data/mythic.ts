...
export const mythicAbilities: MythicAbility[] = [
  ...
  { id: 'enduring-blessing', tier: 3, kind: 'path', name: 'Enduring Blessing (Su)', effect: 'Cuando lanzás un conjuro de duración 10 min/nivel o más sobre un único objetivo dispuesto, podés cambiar su duración a 24 horas. Cada criatura solo puede tener un conjuro así a la vez: si le lanzás otro, el primero termina.', tip: 'Un buff de ≥ 10 min/nivel sobre un aliado dura 24 h (uno por aliado): Freedom of Movement, Resist Energy, Heroism, Status, Air Walk. Sin costo. Magic Vestment: consultar al DM (el objetivo es la armadura).', aon: PATH },
