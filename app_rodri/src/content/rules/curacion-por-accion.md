---
title: "Tabla maestra: curación por acción a CL 11"
section: "Curación"
order: 21
summary: "Media y máximo por objetivo de cada opción, con ejemplos de cuenta."
tags: ["curación","tabla"]
source: "dossier:### 2.3, dossier:### 2.4"
---
...
### Tabla maestra: curación por acción a CL 11 (media / máximo por objetivo)
...
- **Enduring Blessing** (tier 3, elegida el 18/09/2026 en lugar de Abundant Healing, que exige aliados adyacentes a vos): un conjuro de duración ≥ 10 min/nivel sobre un único objetivo dispuesto pasa a durar **24 h** (uno por criatura): Freedom of Movement, Resist Energy, Heroism, Status, Air Walk.
...
### Cuentas de ejemplo (para ver el método)
